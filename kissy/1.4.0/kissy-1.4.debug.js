 ...
 * for example:
 *      @example
 *      KISSY_14.use('overlay,node', function(S, Overlay, Node){
 *          //
 *      });
 *
 ...
 * @class KISSY
 */
var KISSY_14 = (function (undefined) {
    ...
    S = {
        ...
        /**
         * KISSY Config.
         * If load KISSY_14.js, Config.debug defaults to true.
...
(function (S, undefined) {
    ...
    mix(S, {
         ...
         * for example:
         *      @example
         *      S.namespace('KISSY_14.app'); // returns KISSY_14.app
         *      S.namespace('app.Shop'); // returns KISSY_14.app.Shop
...
(function (S, undefined) {
    ...
    Defer.prototype = {
         ...
         * @return {KISSY_14.Promise} defer object's promise
         */
    ...
    /**
     * @class KISSY_14.Promise
     * Promise constructor.
     * This class should not be instantiated manually.
     * Instances will be created and returned as needed by {@link KISSY_14.Defer#promise}
    ...
    Promise.prototype = {
         ...
         * @return {KISSY_14.Promise} a new promise object
         */
    ...
    KISSY_14.Defer = Defer;
    KISSY_14.Promise = Promise;
    Promise.Defer = Defer;

    S.mix(Promise,
        /**
         * @class KISSY_14.PromiseMix
         * @override KISSY_14.Promise
         */
        {
            /**
             * register callbacks when obj as a promise is resolved
             * or call fulfilled callback directly when obj is not a promise object
             * @param {KISSY_14.Promise|*} obj a promise object or value of any type
             ...
             * @param {KISSY_14.Promise[]} promises list of promises
             * @static
             * @return {KISSY_14.Promise}
             */
...
(function (S, undefined) {
     ...
     * @param {String|KISSY_14.Uri} [uriStr] Encoded uri string.
     */
    function Uri(uriStr) {
    ...
    Uri.prototype = {
         ...
         * @param {KISSY_14.Uri|String} relativeUri
         *
         * for example:
         *      @example
        ...
        /**
         * Set query
         * @param {String|KISSY_14.Uri.Query} query
         * @chainable
         */
...
(function (S, undefined) {
    ...
    var UA = KISSY_14.UA = getDescriptorFromUserAgent(ua);
    // nodejs
...
(function (S) {
    ...
    /**
     * Loader Status Enum
     * @enum {Number} KISSY_14.Loader.Status
     */
    Loader.Status = {
        /** init */
        'INIT': 0,
...
(function (S) {
    ...
    S.mix(Utils, {
        ...
        /**
         * Get absolute path of dep module.similar to {@link KISSY_14.Path#resolve}
...
(function (S) {
    ...
    S.augment(Module, {
         ...
         * @return {KISSY_14.Loader.Package}
         */
        getPackage: function () {
            var self = this;
...
(function (S) {
    ...
    S.mix(S, {
         ...
         * If you want a jsonp operation, please use {@link KISSY_14.IO} instead.
         *
        ...
        getScript: function (url, success, charset) {
            // can not use KISSY_14.Uri, url can not be encoded for some url
 ...
 *//**
 * @ignore
 * Declare config info for KISSY_14.
 * @author yiminghe@gmail.com
 */
(function (S, undefined) {
 ...
 * simple loader for KISSY_14. one module on request.
 * @ignore
 * @author yiminghe@gmail.com
 */
(function (S, undefined) {
    ...
    /**
     * @class KISSY_14.Loader.SimpleLoader
            ...
            S.getScript(url, {
                ...
                success: function () {
                    ...
                    if (isCss) {
                        ...
                        // standard browser(except ie9) fire load after KISSY_14.add immediately
                        if (currentMod) {
...
/*
 ...
 - 参考 async 重构，去除递归回调
 *//**
 * combo loader for KISSY_14. using combo to load module files.
 * @ignore
 * @author yiminghe@gmail.com
 */
(function (S) {
    ...
    /**
     * @class KISSY_14.Loader.ComboLoader
    ...
    S.augment(ComboLoader, {
        ...
        /**
         * use, _forceSync for KISSY_14.js, initialize dom,event sync
         */
        use: function (normalizedModNames) {
            var self = this,
                allModNames,
...
(function (S, undefined) {
    ...
    S.mix(S, {
         ...
         *      KISSY_14.add('dom', function(S, xx){
         ...
         *      KISSY_14.use('overlay,dd', function(S, Overlay){});
         */
...
config({
'anim': {requires: ['dom','anim/base','anim/timer',KISSY_14.Features.isTransitionSupported() ? "anim/transition" : ""]}
});
/*Generated By KISSY Module Compiler*/
config({
...
if (KISSY_14.UA.ie !== 6) {
    KISSY_14.add("component/extension/shim-render", function () {
    });
}/*Generated By KISSY Module Compiler*/
config({
...
'xtemplate/compiler': {requires: ['xtemplate/runtime']}
                ...
                KISSY_14.config('modules', c);
                },KISSY_14.Features,KISSY_14.UA);
            /**
 * @ignore
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('dom/base/api', function (S) {
    ...
    var WINDOW = S.Env.host || {},
         ...
         * @enum {Number} KISSY_14.DOM.NodeType
         */
            NodeType = {
            /**
             * element type
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('dom/base/attr', function (S, Dom, undefined) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/base/class', function (S, Dom) {
 ...
 * @author lifesinger@gmail.com, yiminghe@gmail.com
 */
KISSY_14.add('dom/base/create', function (S, Dom, undefined) {
 ...
 * @author lifesinger@gmail.com, yiminghe@gmail.com
 */
KISSY_14.add('dom/base/data', function (S, Dom, undefined) {
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('dom/base/insertion', function (S, Dom) {
 ...
 * @author lifesinger@gmail.com, yiminghe@gmail.com
 */
KISSY_14.add('dom/base/offset', function (S, Dom, undefined) {
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('dom/base/style', function (S, Dom, undefined) {
    var
        WINDOW = /**
         @ignore
         @type window
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('dom/base/selector', function (S, Dom, undefined) {
 ...
 * @author lifesinger@gmail.com, yiminghe@gmail.com
 */
KISSY_14.add('dom/base/traversal', function (S, Dom, undefined) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/base', function (S, Dom) {
    S.mix(S, {
        // compatibility
        DOM:Dom,
        get: Dom.get,
 ...
 * @author lifesinger@gmail.com, yiminghe@gmail.com
 */
KISSY_14.add('dom/class-list', function (S, Dom) {
    var SPACE = ' ',
        RE_CLASS = /[\n\t]/g;
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/ie/attr', function (S, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/ie/create', function (S, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/ie/insertion', function (S, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/ie/style', function (S, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/ie/traversal', function (S, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/ie/input-selection', function (S, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/ie', function (S, Dom) {
    return Dom;
}, {
    requires: [
        './ie/attr',
...
KISSY_14.add("dom/selector/parser", function () {
    ...
    var lexer = new Lexer({
        'rules': [
            [2, /^\[(?:[\t\r\n\f\x20]*)/, function () {
                this.text = KISSY_14.trim(this.text);
            }],
            [3, /^(?:[\t\r\n\f\x20]*)\]/, function () {
                this.text = KISSY_14.trim(this.text);
            }],
            ...
            [10, /^(?:(?:[\w]|[^\x00-\xa0]|(?:\\[^\n\r\f0-9a-f]))(?:[\w\d-]|[^\x00-\xa0]|(?:\\[^\n\r\f0-9a-f]))*)\(/, function () {
                this.text = KISSY_14.trim(this.text).slice(0, - 1);
                this.pushState('fn');
            }],
            [11, /^[^\)]*/, function () {
                this.popState();
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('dom/selector', function (S, parser, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/base/utils', function (S) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/base/object', function (S, undefined) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/base/observer', function (S, undefined) {

    /**
     * KISSY 's base observer for handle user-specified function
     * @private
     * @class KISSY_14.Event.Observer
     * @param {Object} cfg
     */
    ...
    Observer.prototype = {
         ...
         * @param {KISSY_14.Event.Observer} s2 another observer
         * @return {Boolean}
         */
        equals: function (s2) {
            var s1 = this;
         ...
         * @param {KISSY_14.Event.Object} event
         * @param {KISSY_14.Event.Observable} ce
...
KISSY_14.add('event/base/observable', function (S) {
    ...
    Observable.prototype = {
         ...
         * @param {KISSY_14.Event.Observer} s
         * @memberOf KISSY_14.Event.Observable.prototype
         */
         ...
         * @param {KISSY_14.Event.Observer} observer
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/base', function (S, Utils, Object, Observer, Observable) {
    /**
     * The event utility provides functions to add and remove event listeners.
     * @class KISSY_14.Event
     * @singleton
     */
    return {
        Utils: Utils,
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/custom/observer', function (S, BaseEvent) {

    /**
     * Observer for custom event
     * @class KISSY_14.Event.CustomEventObserver
     * @extends KISSY_14.Event.Observer
     * @private
     */
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/custom/object', function (S, BaseEvent) {

    /**
     * Do not new by yourself.
     *
     * Custom event object.
     * @class KISSY_14.Event.CustomEventObject
     * @param {Object} data data which will be mixed into custom event instance
     * @extends KISSY_14.Event.Object
     */
...
/**
 * @ignore
 * custom event mechanism for KISSY_14.
 * refer: http://www.w3.org/TR/domcore/#interface-customevent
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/custom/observable', function (S, CustomEventObserver, CustomEventObject, BaseEvent) {

    var Utils = BaseEvent.Utils;

    /**
     * custom event for registering and un-registering observer for specified event on normal object.
     * @class KISSY_14.Event.ObservableCustomEvent
     * @extends KISSY_14.Event.Observable
     * @private
     */
    function ObservableCustomEvent() {
         ...
         * @cfg {KISSY_14.Event.Target} currentTarget
         */
    }
    ...
    S.extend(ObservableCustomEvent, BaseEvent.Observable, {
         ...
         * @param {Object} cfg {@link KISSY_14.Event.CustomEventObserver} 's config
         */
        on: function (cfg) {
         ...
         * @param {KISSY_14.Event.CustomEventObject} eventData
         ...
         * @param {KISSY_14.Event.CustomEventObject} event
     ...
     * @static
     * @protected
     * @member KISSY_14.Event.ObservableCustomEvent
     * @param {HTMLElement} target
     * @param {String} type event type
     * @param {Boolean} [create] whether create custom event on fly
     * @return {KISSY_14.Event.ObservableCustomEvent}
     */
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/custom/target', function (S, BaseEvent, ObservableCustomEvent) {
    var Utils = BaseEvent.Utils,
     ...
     * and the {@link KISSY_14.Event.CustomEventObject} created will be mixed with eventData
     * @method fire
     * @param {String} type The type of the event
     * @param {Object} [eventData] The data will be mixed with {@link KISSY_14.Event.CustomEventObject} created
     ...
     * @method addTarget
     * @param {KISSY_14.Event.Target} anotherTarget Another EventTarget instance to add
     * @chainable
     */
     ...
     * @method removeTarget
     * @param {KISSY_14.Event.Target} anotherTarget Another EventTarget instance to remove
     * @chainable
     */
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/custom', function (S, Target) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/utils', function (S, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/special', function () {
    return {
    };
});
/**
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/observer', function (S, Special, BaseEvent) {

    /**
     * observer for dom event
     * @class KISSY_14.Event.DOMEventObserver
     * @extends KISSY_14.Event.Observer
     * @private
     */
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/object', function (S, BaseEvent, undefined) {
     ...
     *
     * @class KISSY_14.Event.DOMEventObject
     * @extends KISSY_14.Event.Object
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/observable', function (S, Dom, Special, DOMEventUtils,
     ...
     * @param {Object} cfg
     * @private
     * @class KISSY_14.Event.ObservableDOMEvent
     * @extends KISSY_14.Event.Observable
     */
    ...
    S.extend(ObservableDOMEvent, BaseEvent.Observable, {
        ...
        /**
         * notify current event 's observers
         * @param {KISSY_14.Event.DOMEventObject} event
         * @return {*} return false if one of custom event 's observers  else
         * return last value of custom event 's observers 's return value.
         */
        notify: function (event) {
         ...
         * @param {Object|KISSY_14.Event.DOMEventObject} [event] additional event data
        ...
        /**
         * add a observer to custom event's observers
         * @param {Object} cfg {@link KISSY_14.Event.DOMEventObserver} 's config
         */
        on: function (cfg) {
            var self = this,
                observers = self.observers,
            ...
            if (self.findObserver(/**@type KISSY_14.Event.DOMEventObserver*/observer) == -1) {
                // 增加 listener
                if (observer.filter) {
     ...
     * @param {String} type event type
     * @return {KISSY_14.Event.ObservableDOMEvent}
     */
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/dom-event', function (S, BaseEvent, DOMEventUtils, Dom, Special, ObservableDOMEvent, DOMEventObject) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/key-codes', function (S) {
    /**
     * @enum {Number} KISSY_14.Event.KeyCode
     * All key codes.
     */
    var UA = S.UA,
        KeyCode = {
     ...
     * @param {KISSY_14.Event.DOMEventObject} e event object
     * @return {Boolean}
     */
     ...
     * @param {KISSY_14.Event.KeyCode} keyCode
     * @return {Boolean}
     */
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/gesture', function () {

    /**
     * gesture for event
     * @enum {String} KISSY_14.Event.Gesture
     */
    return {
        /**
         * start gesture
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/special-events', function (S, DOMEvent,Special) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/mouseenter', function (S, Dom, Special) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base/valuechange', function (S, DOMEvent, Dom, Special) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/base', function (S, DOMEvent, KeyCode, Gesture, Special) {
    return S.merge({
        add: DOMEvent.on,
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/focusin', function (S, DOMEvent) {
 ...
 */
KISSY_14.add('event/dom/hashchange', function (S, DOMEvent, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/ie/change', function (S, DOMEvent, Dom) {
    var Special = DOMEvent.Special,
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/ie/submit', function (S, DOMEvent, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/ie', function () {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/shake', function (S, DOMEvent, undefined) {
    var Special = DOMEvent.Special,
        start = 5,
        enough = 20,
        shaking = 0,
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/handle-map', function () {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/gesture', function (S, DOMEvent) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/single-touch', function (S) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/tap', function (S, eventHandleMap, DOMEvent, SingleTouch) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/swipe', function (S, eventHandleMap, DOMEvent, SingleTouch) {
    ...
    function fire(self, e, ing) {
        ...
        DOMEvent.fire(e.target, ing ? ingEvent : event, {
             ...
             *
             * @property touch
             * @member KISSY_14.DOMEvent.DOMEventObject
             */
            touch: touch,
            /**
             *
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/double-tap',
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/multi-touch', function (S, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/pinch', function (S, eventHandleMap, DOMEvent, MultiTouch, Gesture) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/tap-hold', function (S, eventHandleMap, SingleTouch, DOMEvent, Gesture) {
    var event = 'tapHold';
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/rotate', function (S, eventHandleMap, MultiTouch, DOMEvent, Gesture, undefined) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/single-touch-start', function (S, eventHandleMap, DOMEvent, SingleTouch) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch/handle', function (S, Dom, eventHandleMap, DOMEvent, Gesture) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('event/dom/touch', function (S, DOMEvent, eventHandleMap, eventHandle) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('json/quote', function (S) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('json/stringify', function (S,Quote) {
...
/*
  Generated by kissy-kison.*/
KISSY_14.add("json/parser", function () {
    /* Generated by kison from KISSY */
    var parser = {}, S = KISSY,
        GrammarConst = {
            'SHIFT_TYPE': 1,
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('json/parse', function (S, parser, Quote) {
    parser.yy = {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('json', function (S, stringify, parse) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/form-serializer', function (S, Dom) {
    ...
    return FormSerializer = {
         ...
         * form serialization
         * @method
         * @param {HTMLElement[]|HTMLElement|KISSY_14.NodeList} forms form elements
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/base', function (S, Event, undefined) {
    ...
    function fire(eventType, self) {
         ...
         * @member KISSY_14.IO
         * @static
         * @param {KISSY_14.Event.CustomEventObject} e
         * @param {KISSY_14.IO} e.io current io
         */
     ...
     * It is recommended to do so once in the {@link KISSY_14.IO#method-setupConfig}
     *
     * @cfg {Boolean} async
     * Default to: true
     ...
     * Default to: {text:{json:Json.parse,html:mirror,text:mirror,xml:KISSY_14.parseXML}}
     ...
     *
     * 3. io object of this request , for details {@link KISSY_14.IO}
     *
     * @cfg {Function} error
     * success(data,textStatus,xhr)
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/xhr-transport-base', function (S, IO) {
    var OK_CODE = 200,
        win = S.Env.host,
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/sub-domain-transport', function (S, XhrTransportBase, Event, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/xdr-flash-transport', function (S, IO, Dom) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/xhr-transport', function (S, IO, XhrTransportBase, SubDomainTransport, XdrFlashTransport) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/script-transport', function (S, IO, _, undefined) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/jsonp', function (S, IO) {
    var win = S.Env.host;
    IO.setupConfig({
        jsonp: 'callback',
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/form', function (S, IO, Dom, FormSerializer) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/iframe-transport', function (S, Dom, Event, IO) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io/methods', function (S, IO, undefined) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('io', function (S, serializer, IO) {
    var undef = undefined;
    ...
    S.mix(IO,
        {
             ...
             * @param {KISSY_14.IO} callback.io io object of this request
             ...
             * @param {String} url request destination
             * @param {HTMLElement|KISSY_14.NodeList} form element tobe submited
             * @param {Object} [data] name-value object associated with this request
             * @param {Function} [callback]  success callback when this request is done.@param callback.data returned from this request with type specified by dataType
             * @param {String} callback.status status of this request with type String
             * @param {KISSY_14.IO} callback.io io object of this request
 ...
 */
KISSY_14.add('cookie', function (S) {
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('base/attribute', function (S, CustomEvent, undefined) {
     ...
     *
     * NOTE: Most implementations will be better off extending the {@link KISSY_14.Base} class,
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('base', function (S, Attribute) {

    /**
     * @class KISSY_14.Base
     * @mixins KISSY_14.Event.Target
     * @mixins KISSY_14.Base.Attribute
     *
     * A base class which objects requiring attributes and custom event support can
     * extend. attributes configured
     * through the static {@link KISSY_14.Base#static-ATTRS} property for each class
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('anim/base/queue', function (S, Dom) {
 ...
 * @ignore
 */
KISSY_14.add('anim/base/utils', function (S, Dom, Q,undefined) {
 ...
 * @ignore
 */
KISSY_14.add('anim/base', function (S, Dom, Utils, CustomEvent, Q) {
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('anim/timer/easing', function () {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('anim/timer/manager', function (S, undefined) {
    var stamp = S.stamp;
    var win = S.Env.host;
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('anim/timer/fx', function (S, Dom, undefined) {

    /**
     * basic animation about single css property or element attribute
     * @class KISSY_14.Anim.Fx
     * @private
     */
    function Fx(cfg) {
        this.load(cfg);
 ...
 * @ignore
 */
KISSY_14.add('anim/timer/short-hand', function () {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('anim/timer/color', function (S, Dom, Fx,SHORT_HANDS) {
 ...
 * @ignore
 */
KISSY_14.add('anim/timer', function (S, Dom, Event, AnimBase, Easing, AM, Fx, SHORT_HANDS) {
 ...
 * @ignore
 */
KISSY_14.add('anim/transition', function (S, Dom, Event, AnimBase) {
 ...
 * @author yiminghe@gmail.com, lifesinger@gmail.com
 */
KISSY_14.add('node/base', function (S, Dom, Event, undefined) {
    ...
    /**
     * The NodeList class provides a {@link KISSY_14.DOM} wrapper for manipulating Dom Node.
     * use KISSY_14.all/one to retrieve NodeList instances.
     *
     *  for example:
     *      @example
     *      KISSY_14.all('a').attr('href','http://docs.kissyui.com');
     *
     * is equal to
     *      @example
     *      KISSY_14.DOM.attr('a','href','http://docs.kissyui.com');
     *
     * @class KISSY_14.NodeList
     */
    ...
    NodeList.prototype = {
         ...
         * @param {KISSY_14.NodeList} selector Selector string or html string or common dom node.
         * @param {KISSY_14.NodeList|Number} [context] Search context for selector
         * @param {Number} [index] Insert position.
         * @return {KISSY_14.NodeList} a new nodelist
         */
    ...
    S.mix(NodeList, {
         ...
         * Can also called from KISSY_14.all
         * @param {String|KISSY_14.NodeList} selector Selector string or html string or common dom node.
         * @param {String|KISSY_14.NodeList} [context] Search context for selector
         * @return {KISSY_14.NodeList}
         * @member KISSY_14.NodeList
         * @static
         */
    ...
    /**
     * Same with {@link KISSY_14.DOM.NodeType}
     * @member KISSY_14.NodeList
     * @property NodeType
     * @static
     */
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('node/attach', function (S, Dom, Event, NodeList, undefined) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('node/override', function (S, Dom,NodeList) {

    var NLP = NodeList.prototype;

    /**
     * Insert every element in the set of newNodes to the end of every element in the set of current node list.
     * @param {KISSY_14.NodeList} newNodes Nodes to be inserted
     * @return {KISSY_14.NodeList} this
     * @method append
     * @member KISSY_14.NodeList
     */
 ...
 *
 */
KISSY_14.add('node/anim', function (S, Dom, Anim, Node, undefined) {
    ...
    S.augment(Node, {
         ...
         * @param var_args see {@link KISSY_14.Anim}
         * @chainable
         * @member KISSY_14.NodeList
         */
         ...
         * @param {Boolean} [end] see {@link KISSY_14.Anim#static-method-stop}
         * @param [clearQueue]
         * @param [queue]
         * @chainable
         * @member KISSY_14.NodeList
         ...
         * @param {Boolean} end see {@link KISSY_14.Anim#static-method-pause}
         * @param queue
         * @chainable
         * @member KISSY_14.NodeList
         */
         ...
         * @param {Boolean} end see {@link KISSY_14.Anim#static-method-resume}
         * @param queue
         * @chainable
         * @member KISSY_14.NodeList
         */
 ...
 * @author yiminghe@gmail.com
 */
KISSY_14.add('node', function (S, Node) {
    S.mix(S, {
        Node: Node,
        NodeList: Node,
        one: Node.one,
