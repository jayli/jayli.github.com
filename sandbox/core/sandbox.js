...
script.src=url;document.getElementsByTagName("head")[0].appendChild(script);},loadCSS:function(url){var cssLink=document.createElement("link");cssLink.rel="stylesheet";cssLink.rev="stylesheet";cssLink.type="text/css";cssLink.media="screen";cssLink.href=url;document.getElementsByTagName("head")[0].appendChild(cssLink);},load:function(){var that=this;var a=[],b=[];var _cb=arguments[arguments.length-1];var cb=(typeof _cb)=='function'?_cb:new Function;for(var i=0;i<arguments.length;i++){if(typeof arguments[i]=='string'){if(/\.css$/i.test(arguments[i])){that.loadCSS(arguments[i]);}else{a.push(arguments[i]);}}}
var I=0;var loadnext=function(){if(I==a.length-1){var _cb=cb;}else{var _cb=loadnext;}
that.ready(_cb,{requires:[a[I]]});I++;};loadnext();return this;},distinct:function(A){var that=this;if(!(A instanceof Array)||A.length<=1)return A;var a=[],b=[];for(var i=1;i<A.length;i++){for(var j=0;j<i;j++){if(that.inArray(j,b))continue;if(A[j]==A[i]){b.push(j);}}}
